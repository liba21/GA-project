...
df_results.to_csv(
    "../results/statistical_methods/logistic_scan_all_pairs.csv",
    index=False
)
...
df_top.to_csv(
    "../results/statistical_methods/logistic_scan_top125.csv",
    index=False
)
...
df_top_true.to_csv(
    "../results/statistical_methods/logistic_scan_top125_true_pairs.csv",
    index=False
)
...
if len(df_top_true) > 0:
    ...
    plt.savefig("../figures/statistical_methods/logistic_search_scan.png", dpi=300, bbox_inches="tight")
